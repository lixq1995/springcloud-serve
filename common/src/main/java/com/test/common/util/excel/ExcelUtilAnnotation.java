...
/**
 * @author by Lixq
 * @Classname ExcelUtilAnnotation
 * @Description TODO 搜索java excel注解
 * @Date 2021/5/18 23:03
 *//*

public class ExcelUtilAnnotation <T> implements Serializable {

    private static final long serialVersionUID = 551970754610248636L;

    private Class<T> clazz;

    public ExcelUtilAnnotation(Class<T> clazz) {
        this.clazz = clazz;
    }
...
/**
    ...
    public List<T> getExcelToList(String sheetName, InputStream input) {
        ...
        try {
            ...
            throw new BusinessException("将excel表单数据源的数据导入到list异常!", e);
        }
        return list;
    }
